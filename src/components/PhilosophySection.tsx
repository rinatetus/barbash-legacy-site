...
export default function PhilosophySection() {
  ...
  return (
    <section className="py-24 md:py-32 px-6">
      <div ref={ref} className={`container mx-auto max-w-3xl text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
