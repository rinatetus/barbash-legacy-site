...
export default function ExpertiseSection() {
  ...
  return (
    <section id="expertise" className="py-16 md:py-32 px-4 sm:px-6 bg-card relative overflow-hidden">
          ...
          {t.expertise.cards.map((c, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-muted-foreground font-body leading-relaxed">{c.desc}</p>
              </div>
            );
          })}
        </div>
